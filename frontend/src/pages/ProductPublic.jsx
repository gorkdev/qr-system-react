        ...
        <div className="flex h-full items-center justify-center">
          <div className="flex flex-col items-center gap-4 px-4 text-center">
            ...
            <p className="max-w-md text-sm text-muted-foreground">
              Aradığınız ürünü bulamadık, silinmiş veya gösterimden kaldırılmış
              olabilir.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center gap-4 px-4 text-center">
            ...
            {closedLang === "tr" ? (
              <>
                <h1 className="text-lg font-semibold">Ürün Bulunamadı</h1>
                <p className="max-w-md text-sm text-muted-foreground">
                  Aradığınız ürünü bulamadık, silinmiş veya gösterimden
              ...
              <>
                ...
                <p className="max-w-md text-sm text-muted-foreground">
                  The product you are looking for could not be found. It may
                  have been removed or taken off display.
                </p>
              </>
            )}
          </div>
